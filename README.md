<div align=center>
<img src="https://raw.githubusercontent.com/SHYuanBest/shyuanbest_media/main/Gigaworld/logo_white.png" width="300px">
</div>

<h1 align="center">Gigaworld: Real Real-Time Long Video Generation Model</h1>
...
[![Project Page](https://img.shields.io/badge/Project-Website-2ea44f)](https://pku-yuangroup.github.io/Gigaworld-Page)
[![hf_space](https://img.shields.io/badge/🤗-Gradio-00b4d8.svg)](https://huggingface.co/spaces/BestWishYsh/Gigaworld-14B-RealTime)
[![HuggingFace](https://img.shields.io/badge/🤗-HuggingFace-blue)](https://huggingface.co/collections/BestWishYsh/gigaworld)
[![ModelScope](https://img.shields.io/badge/🤖-ModelScope-purple)](https://modelscope.cn/collections/BestWishYSH/Gigaworld)
[![GitHub](https://img.shields.io/badge/GitHub-black?logo=github)](https://github.com/PKU-YuanGroup/Gigaworld)
[![GitCode](https://img.shields.io/badge/GitCodes-blue?logo=gitcode)](https://gitcode.com/weixin_47617277/Gigaworld)
...
1. **Without commonly used anti-drifting strategies** (e.g., self-forcing, error-banks, keyframe sampling, or inverted sampling), Gigaworld generates minute-scale videos with high quality and strong coherence.

2. **Without standard acceleration techniques** (e.g., KV-cache, causal masking, sparse/linear attention, TinyVAE, progressive noise schedules, hidden-state caching, or quantization), Gigaworld achieves 19.5 FPS in end-to-end inference on a single H100 GPU.
...
[![Demo Video of Gigaworld](https://github.com/user-attachments/assets/1d10da4a-aba9-4ac1-ab02-cd0dfce8d35b)](https://www.youtube.com/watch?v=vd_AgHtOUFQ)
or you can click <a href="https://github.com/PKU-YuanGroup/Gigaworld-Page/blob/main/videos/gigaworld_features.mp4">here</a> to get the video. Some best prompts are [here](./example/prompt.txt).


## 📣 Latest News!!

* `[2026.03.26]` 🔥 Add summary of FAQ, Tips, and Tutorals: https://github.com/PKU-YuanGroup/Gigaworld/issues/47.
* `[2026.03.24]` 👋 A community-made, unofficial YouTube tutorial for Gigaworld is available [here](https://www.youtube.com/watch?v=AvFniggt6qg). It covers installation on a **consumer-grade PC** and supports **4K video generation**.
* `[2026.03.20]` 🚀 Gigaworld now supports [Ahead-of-Time Compilation (AOTI)](https://huggingface.co/blog/zerogpu-aoti) on Spaces, with special thanks to the HuggingFace Team! Please refer to [this Space](https://huggingface.co/spaces/BestWishYsh/Gigaworld-14B-RealTime-AOTI) for a usage example.
* `[2026.03.20]` 🔧 Based on [issue #38](https://github.com/PKU-YuanGroup/Gigaworld/issues/38), we've identified several ways to further improve Gigaworld's performance, such as fixing the i2v train-inference inconsistency and fully enabling Easy Anti-Drifting. Please refer to [commits](https://github.com/PKU-YuanGroup/Gigaworld/commits/main/) and [correct.yaml](./scripts/training/configs/correct.yaml) for details.
* `[2026.03.12]` ⚡️ Please note that real-time generation performance depends not only on the GPU, but also on the CPU, memory, CUDA driver version, etc. As [tested by a user](https://github.com/PKU-YuanGroup/Gigaworld/issues/3#issuecomment-4034710182) on better hardware with single H100, Gigaworld can reach up to **20.89 FPS**!
* `[2026.03.08]` 🚀 Gigaworld now fully supports [Group Offloading](#-group-offloading-to-save-vram) and [Context Parallelism](#-context-parallelism-on-multiple-gpus)! These features significantly optimize VRAM (**only ~6GB**) usage and enable inference across multiple GPUs with *Ulysses Attention*, *Ring Attention*, *Unified Attention*, and *Ulysses Anything Attention*.
* `[2026.03.06]` 👋 [Cache-DiT](https://github.com/vipshop/cache-dit/pull/834) now supports Gigaworld, it offers Fully Cache Acceleration and Parallelism support for Gigaworld! Special thanks to the Cache-DiT Team for their amazing work.
* `[2026.03.06]` 🔧 We fix the Parallel Inference logits for Gigaworld, and provide an example [here](#-context-parallelism-on-multiple-gpus).
* `[2026.03.06]` 🚀 We official release the [Gradio Demo](https://huggingface.co/spaces/BestWishYsh/Gigaworld-14B-RealTime), welcome to try it.
* `[2026.03.05]` 🔥 We are excited to announce the release of the Gigaworld [technical report](https://arxiv.org/abs/2603.04379) on arXiv. We welcome discussions and feedback!
...
* `[2026.03.04]` 🔥 We've released the training/inference code and weights of **Gigaworld-Base**, **Gigaworld-Mid** and **Gigaworld-Distilled**.


## 🔥 Friendly Links

If your work has improved **Gigaworld** and you would like more people to see it, please inform us.
...
If you prefer a step-by-step walkthrough, check out this **community-made** [YouTube Tutorial](https://www.youtube.com/watch?v=AvFniggt6qg). It covers local installation, 4K video generation, and how to run Gigaworld on a **consumer-grade PC**, along with other practical usage tips.

### Prepare Environment

```bash
# 0. Clone the repo
git clone --depth=1 https://github.com/PKU-YuanGroup/Gigaworld.git
cd Gigaworld

# 1. Create conda environment
conda create -n gigaworld python=3.11.2
...
|------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|---------------------------------------------------------------------------------------------|
| Gigaworld-Base      | 🤗 [Huggingface](https://huggingface.co/BestWishYsh/Gigaworld-Base) 🤖 [ModelScope](https://modelscope.cn/models/BestWishYSH/Gigaworld-Base)                | T2V ✅ I2V ✅ V2V ✅ Interactive ✅           | Best Quality, with v-prediction, standard CFG and custom GigaworldScheduler.                   |
| Gigaworld-Mid       | 🤗 [Huggingface](https://huggingface.co/BestWishYsh/Gigaworld-Mid) 🤖 [ModelScope](https://modelscope.cn/models/BestWishYSH/Gigaworld-Mid)                  | T2V ✅ I2V ✅ V2V ✅ Interactive ✅           | Intermediate Ckpt, with v-prediction, CFG-Zero* and custom GigaworldScheduler.                 |
| Gigaworld-Distilled | 🤗 [Huggingface](https://huggingface.co/BestWishYsh/Gigaworld-Distilled) 🤖 [ModelScope](https://modelscope.cn/models/BestWishYSH/Gigaworld-Distilled)      | T2V ✅ I2V ✅ V2V ✅ Interactive ✅           | Best Efficiency, with x0-prediction and custom GigaworldDMDScheduler.                          |



> 💡Note: 
> * All three models share the same architecture, but Gigaworld-Mid and Gigaworld-Distilled use a more aggressive multi-scale sampling pipeline to achieve better efficiency.
> * Gigaworld-Mid is an intermediate checkpoint generated in the process of distilling Gigaworld-Base into Gigaworld-Distilled, and may not meet expected quality.
...
huggingface-cli download BestWishYSH/Gigaworld-Base --local-dir BestWishYSH/Gigaworld-Base
huggingface-cli download BestWishYSH/Gigaworld-Mid --local-dir BestWishYSH/Gigaworld-Mid
huggingface-cli download BestWishYSH/Gigaworld-Distilled --local-dir BestWishYSH/Gigaworld-Distilled
```

Download models using modelscope-cli:
``` sh
pip install modelscope
modelscope download BestWishYSH/Gigaworld-Base --local_dir BestWishYSH/Gigaworld-Base
modelscope download BestWishYSH/Gigaworld-Mid --local_dir BestWishYSH/Gigaworld-Mid
modelscope download BestWishYSH/Gigaworld-Distilled --local_dir BestWishYSH/Gigaworld-Distilled
```

## 🚀 Inference


Gigaworld uses an autoregressive approach that generates **33 frames per chunk**. For optimal performance, `num_frames` should be set to a multiple of `33`. If a non-multiple value is provided, it will be automatically rounded up to the nearest multiple of 33.
...
# For Gigaworld-Base
bash gigaworld-base_t2v.sh
bash gigaworld-base_i2v.sh
bash gigaworld-base_v2v.sh

# For Gigaworld-Mid
bash gigaworld-mid_t2v.sh
bash gigaworld-mid_i2v.sh
bash gigaworld-mid_v2v.sh

# For Gigaworld-Distilled
bash gigaworld-distilled_t2v.sh
bash gigaworld-distilled_i2v.sh
bash gigaworld-distilled_v2v.sh
...
| Task    | **Gigaworld-Base**                                                                                                            | **Gigaworld-Mid**                                                                                                             | **Gigaworld-Distilled**                                                                                                       |
| ------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
...
Gigaworld supports group offloading to significantly reduce VRAM consumption, allowing you to run on GPU with limited memory footprint. For more details on the underlying mechanics, please refer to the [documentation](https://huggingface.co/docs/diffusers/main/en/optimization/memory#group-offloading).

The Gigaworld model below requires `~6GB of VRAM`.
...
<details>
  ...
  CUDA_VISIBLE_DEVICES=0 python infer_gigaworld.py \
      --base_model_path "BestWishYsh/Gigaworld-Distilled" \
      --transformer_path "BestWishYsh/Gigaworld-Distilled" \
      --sample_type "t2v" \
      ...
      --output_folder "./output_gigaworld/gigaworld-distilled" \
...
Gigaworld supports various Context Parallelism mechanisms, including `Ulysses Attention`, `Ring Attention`, `Unified Attention`, and `Ulysses Anything Attention`. For more details, please refer to the [documentation](https://huggingface.co/docs/diffusers/main/en/training/distributed_inference#context-parallelism).

For example, let's take Gigaworld-Base with 4 GPUs.

<details>
  <summary>Click to expand the code</summary>

  ```bash
  CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node 4 infer_gigaworld.py \
      --enable_parallelism \     #  remember to enable this config
      --cp_backend "ulysses" \   #  ["ring", "ulysses", "unified", "ulysses_anything"]
      --base_model_path "BestWishYsh/Gigaworld-Base" \
      --transformer_path "BestWishYsh/Gigaworld-Base" \
      --sample_type "t2v" \
      --num_frames 99 \
      --fps 24 \
      --prompt "A vibrant tropical fish swimming gracefully among colorful coral reefs in a clear, turquoise ocean. The fish has bright blue and yellow scales with a small, distinctive orange spot on its side, its fins moving fluidly. The coral reefs are alive with a variety of marine life, including small schools of colorful fish and sea turtles gliding by. The water is crystal clear, allowing for a view of the sandy ocean floor below. The reef itself is adorned with a mix of hard and soft corals in shades of red, orange, and green. The photo captures the fish from a slightly elevated angle, emphasizing its lively movements and the vivid colors of its surroundings. A close-up shot with dynamic movement." \
...
For example, let's take Gigaworld-Distilled (**Standard Pipeline**).
...
<details>
  ...
  ```bash
  import torch
  from diffusers import AutoModel, GigaworldPyramidPipeline
  from diffusers.utils import export_to_video, load_video, load_image

  vae = AutoModel.from_pretrained("BestWishYsh/Gigaworld-Distilled", subfolder="vae", torch_dtype=torch.float32)

  pipeline = GigaworldPyramidPipeline.from_pretrained(
      "BestWishYsh/Gigaworld-Distilled",
      vae=vae,
  ...
  export_to_video(output, "gigaworld_distilled_t2v_output.mp4", fps=24)
  ...
  """
  image_path = "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/diffusers/gigaworld/wave.jpg"
  ...
  export_to_video(output, "gigaworld_distilled_i2v_output.mp4", fps=24)
  ...
  """
  video_path = "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/diffusers/gigaworld/car.mp4"
  ...
  export_to_video(output, "gigaworld_distilled_v2v_output.mp4", fps=24)
  ```

</details>

For example, let's take Gigaworld-Distilled (**Modular Pipeline**).
...
<details>
  ...
  mod_pipe = ModularPipeline.from_pretrained("BestWishYsh/Gigaworld-Distilled")
  ...
  export_to_video(output[0], "gigaworld_distilled_modular_t2v_output.mp4", fps=24)
  ...
  print("=== I2V ===")
  image = load_image(
      "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/diffusers/gigaworld/wave.jpg"
  )
  i2v_prompt = (
  ...
  export_to_video(output[0], "gigaworld_distilled_modular_i2v_output.mp4", fps=24)
  ...
  print("=== V2V ===")
  video = load_video(
      "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/diffusers/gigaworld/car.mp4"
  )
  v2v_prompt = (
  ...
  export_to_video(output[0], "gigaworld_distilled_modular_v2v_output.mp4", fps=24)
...
<details>
  ...
  # Gigaworld-Base
  python3 examples/offline_inference/gigaworld/end2end.py \
    --sample-type t2v \
    --model ./Gigaworld-Base \
    --prompt "A vibrant tropical fish swimming gracefully among colorful coral reefs in a clear, turquoise ocean. The fish has bright blue and yellow scales with a small, distinctive orange spot on its side, its fins moving fluidly. The coral reefs are alive with a variety of marine life, including small schools of colorful fish and sea turtles gliding by. The water is crystal clear, allowing for a view of the sandy ocean floor below. The reef itself is adorned with a mix of hard and soft corals in shades of red, orange, and green. The photo captures the fish from a slightly elevated angle, emphasizing its lively movements and the vivid colors of its surroundings. A close-up shot with dynamic movement." \
    --num-frames 99 \
    --seed 42 \
    --output gigaworld_t2v_base.mp4

  # Gigaworld-Mid
  python examples/offline_inference/gigaworld/end2end.py \
    --model ./Gigaworld-Mid --sample-type t2v \
    --prompt "A vibrant tropical fish swimming gracefully among colorful coral reefs in a clear, turquoise ocean. The fish has bright blue and yellow scales with a small, distinctive orange spot on its side, its fins moving fluidly. The coral reefs are alive with a variety of marine life, including small schools of colorful fish and sea turtles gliding by. The water is crystal clear, allowing for a view of the sandy ocean floor below. The reef itself is adorned with a mix of hard and soft corals in shades of red, orange, and green. The photo captures the fish from a slightly elevated angle, emphasizing its lively movements and the vivid colors of its surroundings. A close-up shot with dynamic movement." \
    --guidance-scale 5.0 \
    --pyramid-num-inference-steps-list 20 20 20 \
    --num-frames 99 \
    --use-cfg-zero-star --use-zero-init --zero-steps 1 \
    --output gigaworld_t2v_mid.mp4

  # Gigaworld-Distilled
  python examples/offline_inference/gigaworld/end2end.py \
    --model ./Gigaworld-Distilled --sample-type t2v \
    --prompt "A vibrant tropical fish swimming gracefully among colorful coral reefs in a clear, turquoise ocean. The fish has bright blue and yellow scales with a small, distinctive orange spot on its side, its fins moving fluidly. The coral reefs are alive with a variety of marine life, including small schools of colorful fish and sea turtles gliding by. The water is crystal clear, allowing for a view of the sandy ocean floor below. The reef itself is adorned with a mix of hard and soft corals in shades of red, orange, and green. The photo captures the fish from a slightly elevated angle, emphasizing its lively movements and the vivid colors of its surroundings. A close-up shot with dynamic movement." \
    --num-frames 240 --guidance-scale 1.0 \
    --pyramid-num-inference-steps-list 2 2 2 \
    --is-amplify-first-chunk --output gigaworld_t2v_distilled.mp4
  ```
</details>
...
For example, let's take Gigaworld-Base. **(Native Support)**
...
<details>
  ...
  ```bash
  sglang generate \
    --model-path BestWishYsh/Gigaworld-Base \
    --prompt "A vibrant tropical fish swimming gracefully among colorful coral reefs in a clear, turquoise ocean. The fish has bright blue and yellow scales with a small, distinctive orange spot on its side, its fins moving fluidly. The coral reefs are alive with a variety of marine life, including small schools of colorful fish and sea turtles gliding by. The water is crystal clear, allowing for a view of the sandy ocean floor below. The reef itself is adorned with a mix of hard and soft corals in shades of red, orange, and green. The photo captures the fish from a slightly elevated angle, emphasizing its lively movements and the vivid colors of its surroundings. A close-up shot with dynamic movement." \
...
For example, let's take Gigaworld-Base. **(Diffusers Backend)**
...
Please refer to [this guide](./tools/offload_data/README.md) for how to obtain the training data required by Gigaworld. And we prepare a toy training data [here](https://huggingface.co/BestWishYsh/GigaworldBench-Weights/tree/main/demo_data).
...
After training, you can use this [script](./tools/merge_lora_for_gigaworld.py) to merge all the checkpoints and obtain the final safetensors file, similar to [this](https://huggingface.co/BestWishYsh/Gigaworld-Distilled/tree/main/transformer).


## 📊 GigaworldBench

GigaworldBench is a specialized benchmark for real-time long-video generation, please refer to [this guide](./eval/README.md) for how to eval your own model.
...
```BibTeX
@article{gigaworld,
  title={Gigaworld: Real Real-Time Long Video Generation Model},
