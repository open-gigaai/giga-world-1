...
from diffusers.loaders import GigaworldLoraLoaderMixin
from diffusers.models import AutoencoderKLWan, GigaworldTransformer3DModel
from gigaworld.modules.transformer_functrl_gigaworld import GigaworldTransformer3DModelFunCtrl
from diffusers.pipelines.pipeline_utils import DiffusionPipeline
from diffusers.schedulers import GigaworldScheduler
from diffusers.utils import is_ftfy_available, is_torch_xla_available, logging, replace_example_docstring
from diffusers.utils.torch_utils import randn_tensor
from diffusers.video_processor import VideoProcessor

from ..pipelines.pipeline_output import GigaworldPipelineOutput
...
class GigaworldPipeline(DiffusionPipeline, GigaworldLoraLoaderMixin):
    r"""
    ...
    Args:
        ...
        transformer ([`GigaworldTransformer3DModel`]):
...
class GigaworldFunCtrlPipeline(DiffusionPipeline, GigaworldLoraLoaderMixin):
    r"""
    Pipeline for text-to-video / image-to-video / video-to-video generation using Gigaworld.
    ...
    def stage1_sample(
        ...
        for i, t in enumerate(timesteps):
            ...
            # TODO: DEBUG ZERO INIT CONTROL LATENTS FOR DEBUG
            #control_latents = torch.zeros(batch_size, 16, 3*latents.shape[2], latents.shape[3], latents.shape[4], device=device, dtype=transformer_dtype)
            ...
            # NOTE: 啥意思？为什么要裁剪？控制信号的帧数可能多于潜空间的帧数，所以裁剪掉多余的帧
    ...
    def __call__(
        ...
        video_noise_sigma_max: float = 0.135,
        # ------------ CONTROL ------------
        control_video: PipelineImageInput | None = None,
        ...
        # 5. Prepare latent variables
        #num_channels_latents = self.transformer.config.in_channels
        num_channels_latents = 16 #TODO: REMOVE HARDCODE
        window_num_frames = (num_latent_frames_per_chunk - 1) * self.vae_scale_factor_temporal + 1
        num_latent_chunk = max(1, (num_frames + window_num_frames - 1) // window_num_frames)
        num_history_latent_frames = sum(history_sizes)
        history_video = None
