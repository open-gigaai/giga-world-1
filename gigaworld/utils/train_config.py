...
class DataConfig:
    # ---- Filter Tasks ----
    filter_tasks: Optional[list[str]] = field(default=None)
    # ---- Base ----
    ...
    # ---- Stage 3 ----
    use_stage2_dataset: bool = field(default=False)
...
class ModelConfig:
    ...
    model_type: Optional[str] = field(default="wan2.1")
    # ----- Stage 3 -----
    ...
    # ---- Control Branch ----
    is_control_model: bool = field(default=False)
...
class ValidationConfig:
    ...
    validation_control_video: Optional[list[str]] = field(default_factory=lambda: ["example/control_videos/frog.mp4"])
    validation_first_image: Optional[list[str]] = None
    validation_view_mode: Optional[str] = None
...
@dataclass
class Args:
    output_dir: str = field(default="Gigaworld")
