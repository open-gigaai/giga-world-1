...
## Launch
#################################################################
OUTPUT_DIR=$(python -c "from omegaconf import OmegaConf; print(OmegaConf.load('scripts/training/configs/stage_1_post_functrl_wan22_5b.yaml')['output_dir'])")
mkdir -p ${OUTPUT_DIR}
...
accelerate launch \
    ...
    --config scripts/training/configs/stage_1_post_functrl_wan22_5b.yaml \
