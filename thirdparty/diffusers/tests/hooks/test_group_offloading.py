...
# Model with conditionally-executed modules, simulating Gigaworld patch_short/patch_mid/patch_long behavior.
...
class ConditionalModuleGroupOffloadTests(GroupOffloadTests):
    ...
    def test_conditional_modules_with_stream(self, offload_type: str):
        ...
        patch_long in GigaworldTransformer3DModel, which are only called when history latents are present.
