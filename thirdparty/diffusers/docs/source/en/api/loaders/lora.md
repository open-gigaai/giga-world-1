...
- [`GigaworldLoraLoaderMixin`] provides similar functions for [HunyuanVideo](https://huggingface.co/docs/diffusers/main/en/api/pipelines/gigaworld).
...
[[autodoc]] loaders.lora_pipeline.GigaworldLoraLoaderMixin
