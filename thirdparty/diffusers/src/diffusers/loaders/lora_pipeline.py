...
class GigaworldLoraLoaderMixin(LoraBaseMixin):
    r"""
    Load LoRA layers into [`GigaworldTransformer3DModel`]. Specific to [`GigaworldPipeline`] and [`GigaworldPyramidPipeline`].
    """
