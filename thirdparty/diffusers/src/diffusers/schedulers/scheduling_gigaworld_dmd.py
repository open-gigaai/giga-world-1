...
@dataclass
class GigaworldDMDSchedulerOutput(BaseOutput):
...
class GigaworldDMDScheduler(SchedulerMixin, ConfigMixin):
    _compatibles = []
    order = 1
    ...
    def step(
    ...
    ) -> GigaworldDMDSchedulerOutput | tuple:
        ...
        return GigaworldDMDSchedulerOutput(prev_sample=prev_sample)
