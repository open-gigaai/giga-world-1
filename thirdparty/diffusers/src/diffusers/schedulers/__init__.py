...
try:
    ...
    _import_structure["scheduling_gigaworld"] = ["GigaworldScheduler"]
    _import_structure["scheduling_gigaworld_dmd"] = ["GigaworldDMDScheduler"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .scheduling_gigaworld import GigaworldScheduler
        from .scheduling_gigaworld_dmd import GigaworldDMDScheduler
