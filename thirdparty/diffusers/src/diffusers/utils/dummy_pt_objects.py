...
class GigaworldTransformer3DModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class GigaworldDMDScheduler(metaclass=DummyObject):
    _backends = ["torch"]
...
class GigaworldScheduler(metaclass=DummyObject):
    _backends = ["torch"]
