...
from ...loaders import GigaworldLoraLoaderMixin
from ...models import AutoencoderKLWan, GigaworldTransformer3DModel
from ...schedulers import GigaworldDMDScheduler, GigaworldScheduler
...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from diffusers import AutoencoderKLWan, GigaworldPyramidPipeline
        ...
        >>> pipe = GigaworldPyramidPipeline.from_pretrained(model_id, vae=vae, torch_dtype=torch.bfloat16)
        >>> pipe.to("cuda")
...
class GigaworldPyramidPipeline(DiffusionPipeline, GigaworldLoraLoaderMixin):
    r"""
    ...
    Args:
        ...
        scheduler ([`GigaworldScheduler`, `GigaworldDMDScheduler`]):
    ...
    # Copied from diffusers.pipelines.gigaworld.pipeline_gigaworld.GigaworldPipeline._get_t5_prompt_embeds
