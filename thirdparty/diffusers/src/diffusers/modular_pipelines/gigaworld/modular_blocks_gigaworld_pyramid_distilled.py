...
from .denoise import GigaworldPyramidDistilledChunkDenoiseStep, GigaworldPyramidDistilledI2VChunkDenoiseStep
...
# auto_docstring
class GigaworldPyramidDistilledAutoVaeEncoderStep(AutoPipelineBlocks):
    """
...
# DENOISE (T2V)
# auto_docstring
class GigaworldPyramidDistilledCoreDenoiseStep(SequentialPipelineBlocks):
    """
    ...
    block_classes = [
        GigaworldTextInputStep,
        GigaworldPrepareHistoryStep,
        GigaworldPyramidDistilledChunkDenoiseStep,
    ]
...
# DENOISE (I2V)
# auto_docstring
class GigaworldPyramidDistilledI2VCoreDenoiseStep(SequentialPipelineBlocks):
    """
    ...
    block_classes = [
        ...
        GigaworldPrepareHistoryStep,
        GigaworldI2VSeedHistoryStep,
        GigaworldPyramidDistilledI2VChunkDenoiseStep,
    ]
    block_names = [
        "input",
        "additional_inputs",
...
# DENOISE (V2V)
# auto_docstring
class GigaworldPyramidDistilledV2VCoreDenoiseStep(SequentialPipelineBlocks):
    """
...
# AUTO DENOISE
# auto_docstring
class GigaworldPyramidDistilledAutoCoreDenoiseStep(ConditionalPipelineBlocks):
    """
    Distilled pyramid core denoise step that selects the appropriate denoising block.
       - `GigaworldPyramidDistilledV2VCoreDenoiseStep` (video2video) for video-to-video tasks.
       - `GigaworldPyramidDistilledI2VCoreDenoiseStep` (image2video) for image-to-video tasks.
       - `GigaworldPyramidDistilledCoreDenoiseStep` (text2video) for text-to-video tasks.
    ...
    block_classes = [
        GigaworldPyramidDistilledV2VCoreDenoiseStep,
        GigaworldPyramidDistilledI2VCoreDenoiseStep,
        GigaworldPyramidDistilledCoreDenoiseStep,
    ]
...
DISTILLED_PYRAMID_AUTO_BLOCKS = InsertableDict(
    [
        ...
        ("vae_encoder", GigaworldPyramidDistilledAutoVaeEncoderStep()),
        ("denoise", GigaworldPyramidDistilledAutoCoreDenoiseStep()),
...
# auto_docstring
class GigaworldPyramidDistilledAutoBlocks(SequentialPipelineBlocks):
    """
    Auto Modular pipeline for distilled pyramid progressive generation (T2V/I2V/V2V) using Gigaworld.
    ...
    @property
    def description(self):
        return "Auto Modular pipeline for distilled pyramid progressive generation (T2V/I2V/V2V) using Gigaworld."
