...
from .denoise import GigaworldPyramidChunkDenoiseStep, GigaworldPyramidI2VChunkDenoiseStep
...
# auto_docstring
class GigaworldPyramidAutoVaeEncoderStep(AutoPipelineBlocks):
    """
...
# DENOISE (T2V)
# auto_docstring
class GigaworldPyramidCoreDenoiseStep(SequentialPipelineBlocks):
    """
    T2V pyramid denoise block with progressive multi-resolution denoising.

      Components:
          transformer (`GigaworldTransformer3DModel`) scheduler (`GigaworldScheduler`) guider
    ...
    block_classes = [
        GigaworldTextInputStep,
        GigaworldPrepareHistoryStep,
        GigaworldPyramidChunkDenoiseStep,
    ]
...
# DENOISE (I2V)
# auto_docstring
class GigaworldPyramidI2VCoreDenoiseStep(SequentialPipelineBlocks):
    """
    ...
    block_classes = [
        ...
        GigaworldPrepareHistoryStep,
        GigaworldI2VSeedHistoryStep,
        GigaworldPyramidI2VChunkDenoiseStep,
    ]
    block_names = [
        "input",
        "additional_inputs",
...
# DENOISE (V2V)
# auto_docstring
class GigaworldPyramidV2VCoreDenoiseStep(SequentialPipelineBlocks):
    """
...
# AUTO DENOISE
# auto_docstring
class GigaworldPyramidAutoCoreDenoiseStep(ConditionalPipelineBlocks):
    """
    Pyramid core denoise step that selects the appropriate denoising block.
       - `GigaworldPyramidV2VCoreDenoiseStep` (video2video) for video-to-video tasks.
       - `GigaworldPyramidI2VCoreDenoiseStep` (image2video) for image-to-video tasks.
       - `GigaworldPyramidCoreDenoiseStep` (text2video) for text-to-video tasks.
    ...
    block_classes = [GigaworldPyramidV2VCoreDenoiseStep, GigaworldPyramidI2VCoreDenoiseStep, GigaworldPyramidCoreDenoiseStep]
...
PYRAMID_AUTO_BLOCKS = InsertableDict(
    [
        ...
        ("vae_encoder", GigaworldPyramidAutoVaeEncoderStep()),
        ("denoise", GigaworldPyramidAutoCoreDenoiseStep()),
...
# auto_docstring
class GigaworldPyramidAutoBlocks(SequentialPipelineBlocks):
    """
    Auto Modular pipeline for pyramid progressive generation (T2V/I2V/V2V) using Gigaworld.
    ...
    @property
    def description(self):
        return "Auto Modular pipeline for pyramid progressive generation (T2V/I2V/V2V) using Gigaworld."
