...
def get_t5_prompt_embeds(
    ...
    """Encode text prompts into T5 embeddings for Gigaworld.
...
class GigaworldTextEncoderStep(ModularPipelineBlocks):
...
class GigaworldImageVaeEncoderStep(ModularPipelineBlocks):
...
class GigaworldVideoVaeEncoderStep(ModularPipelineBlocks):
