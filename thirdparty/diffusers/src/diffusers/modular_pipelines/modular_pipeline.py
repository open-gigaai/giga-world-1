...
def _gigaworld_pyramid_map_fn(config_dict=None):
    if config_dict is None:
        return "GigaworldPyramidModularPipeline"

    if config_dict.get("is_distilled", False):
        return "GigaworldPyramidDistilledModularPipeline"
    else:
        return "GigaworldPyramidModularPipeline"
...
MODULAR_PIPELINE_MAPPING = OrderedDict(
    [
        ...
        ("gigaworld", _create_default_map_fn("GigaworldModularPipeline")),
        ("gigaworld-pyramid", _gigaworld_pyramid_map_fn),
